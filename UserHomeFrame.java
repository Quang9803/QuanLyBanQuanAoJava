...
private JPanel createNavbar() {
    ...
    wishlistBtn.addActionListener(e -> new WishlistFrame());
    ...
    // Tạo SearchPanel trước
    SearchPanel searchPanel = new SearchPanel(this::showAllCategoriesWithProducts);
    ...
    // Thực hiện tìm kiếm sau khi panel đã được hiển thị
    SwingUtilities.invokeLater(() -> {
        try {
            ...
            e.printStackTrace();
            showAllCategoriesWithProducts(); // Quay lại trang chủ nếu có lỗi
        }
    });
}
    ...
    private void showCartPanel() {
        contentPanel.removeAll();
        contentPanel.add(new CartPanel());
        contentPanel.revalidate();
        contentPanel.repaint();
    }
    ...
    public static void main(String args[]) {
        User testUser = new User("testuser", "password", "test@example.com", "0123456789", "user");
        SwingUtilities.invokeLater(() -> new UserHomeFrame(testUser));
    }
}
